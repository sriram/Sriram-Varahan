...
Gem::Specification.new do |s|
  ...
  s.files = ["COPYING", "README.rdoc", "Rakefile", "lib/appengine-apis/apiproxy.rb", "lib/appengine-apis/datastore.rb", "lib/appengine-apis/datastore_types.rb", "lib/appengine-apis/images.rb", "lib/appengine-apis/labs/taskqueue.rb", "lib/appengine-apis/local_boot.rb", "lib/appengine-apis/logger.rb", "lib/appengine-apis/mail.rb", "lib/appengine-apis/memcache.rb", "lib/appengine-apis/merb-logger.rb", "lib/appengine-apis/sdk.rb", "lib/appengine-apis/tempfile.rb", "lib/appengine-apis/testing.rb", "lib/appengine-apis/urlfetch.rb", "lib/appengine-apis/users.rb", "lib/appengine-apis/xmpp.rb", "lib/appengine-apis.rb", "lib/imagescience.rb", "spec/datastore_spec.rb", "spec/datastore_types_spec.rb", "spec/logger_spec.rb", "spec/mail_spec.rb", "spec/memcache_spec.rb", "spec/spec_helper.rb", "spec/taskqueue_spec.rb", "spec/urlfetch_spec.rb", "spec/users_spec.rb", "spec/xmpp_spec.rb"]
